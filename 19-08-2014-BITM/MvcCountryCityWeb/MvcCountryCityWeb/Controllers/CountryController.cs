...
namespace MvcCountryCityWeb.Controllers
{
    public class CountryController : Controller
    {
        ...
        public ActionResult Index([Bind(Include="CountryId,Name,About")] Country country)
        {
        ...
        public ActionResult IsNewCountry(string name)
        {
            bool isNew = true;
            try
            {
                isNew = (db.Countries.Single(c => c.Name == name) == null);
            }
            catch { }
