...
namespace AspDropdownTestApp.Controllers
{
    public class StudentController : Controller
    {
        ...
        public ActionResult Create([Bind(Include="StudentId,RegNo,Name,Email,DepartmentId")] Student student)
        {
            if (ModelState.IsValid)
            {
                if (HasStudent(student))
                {
                    TempData["msg"] = "Student Already Exist";
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include="StudentId,RegNo,Name,Email,DepartmentId")] Student student)
        {
            if (ModelState.IsValid)
            {
